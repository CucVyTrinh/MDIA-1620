...
let horseName = "CucPhuong"; // this is a string
horseName = "CucPhuong"; // for strings, prefer double quotes
let horseAge = "5";
horseAge = 5;
...
if (isHorseInside) [console.log(horseName + " is inside")];
...
let inside = true;
if (inside) [console.log(firstHorseName + " is inside")];
if (inside) [console.log(secondHorseName + "is outside")];
if (inside) [console.log(thirdHorseName) + "is inside"];
